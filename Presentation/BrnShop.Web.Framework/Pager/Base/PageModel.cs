...
namespace BrnShop.Web.Framework
{
    ...
    {
        private int _pageindex;//页面索引
        private int _pagenumber;//页码
        private int _prepagenumber;//上一页
        private int _nextpagenumber;//下一页
        private int _pagesize;//页面大小
        private int _totalcount;//总数
        private int _totalpages;//总页数
        private bool _hasprepage;//是否存在上一页
        private bool _hasnextpage;//是否存在下一页
